...
<body class="home">
  ...
  <article class="content gap--40">
    <div class="column">
      <div class="intro">
        <h2>A collection of visual inspiration.</h2>
        <p>&horbar;&horbar;</p>
      ...
      <p>This MEMEX is a simple application that reads all images from a given directory and displays them on a page. You can enlarge and reduce any image by clicking or tapping.</p>
      <p>Read the <a href="colophon.php">colophon</a> for more information about how this MEMEX works.</p>
